...
export const GET: RequestHandler = async ({ url }) => {
	...
	headers.append('Set-Cookie', `discord_access_token=${response.access_token}; Expires=${accessTokenExpires.toUTCString()}; Path=/; SameSite=Strict; HttpOnly;`);
	headers.append('Set-Cookie', `discord_refresh_token=${response.refresh_token}; Expires=${refreshTokenExpires.toUTCString()}; Path=/; SameSite=Strict; HttpOnly;`);
