...
<main class="flex flex-col justify-center items-center gap-8 mb-16">
	...
	{#if true || data.guild?.banner}
		...
		>
			...
			<div class="flex flex-col p-4 items-center bg-zinc-900/75 mb-32 rounded-lg">
				...
				<h1 class="text-8xl font-semibold font-sans text-white select-none">
					{#if start > time}
	...
	<div class="flex flex-col lg:flex-row gap-8">
		<section class="flex flex-1 basis-1/3 flex-col gap-4 max-w-64 bg-gray-100 dark:bg-zinc-800 rounded-md p-4 py-8">
		...
		<section
			class="flex flex-1 basis-1/3 flex-col gap-4 items-center bg-gray-100 dark:bg-zinc-800 rounded-md p-4 py-8"
		>
			<h2 class="text-3xl">Event Members</h2>
			{#if members.length > 0}
						...
						<div class="flex flex-row justify-between align-middle w-full">
							<div class="flex flex-row gap-2 align-middle">
								...
								<img
									...
									alt="Player Head"
									class="w-8 h-8 pixelated aspect-square"
								/>
