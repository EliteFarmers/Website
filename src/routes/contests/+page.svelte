    ...
    <div class="flex flex-col md:flex-row gap-8 items-center">
        <Card color="none" class="bg-gray-100 dark:bg-zinc-800" border={false}>
            <h2 class="font-semibold text-lg">
                View upcoming contests from this Skyblock Year!
            </h2>
        ...
        <Card color="none" class="bg-gray-100 dark:bg-zinc-800" border={false}>
            <h2 class="font-semibold text-lg">
                View all contest participations from a player!
            </h2>
    ...
    <div class="my-8 mb-32 flex justify-center md:w-[50rem]">
        <Card color="none" class="bg-gray-100 dark:bg-zinc-800 min-w-full" border={false}>
            <div class="flex flex-col md:flex-row gap-8 items-center justify-center">
                <div class="flex-1">
                    <h2 class="font-semibold text-lg">
                        Delve Through The Archives
                    </h2>
                    <p class="text-md my-4">Look through the rankings of every known participant in every known contest. Also try clicking on contest participations elsewhere on the site to jump to that contest.</p>
                </div>
                <div class="flex-1 flex flex-col gap-4 items-end">
                    <form on:submit|preventDefault={searchContestYear} class="flex gap-2 items-center justify-center">
                        <div>
                            ...
                            <Input id="yearOnly" placeholder="Day" size="md" bind:value={yearVal} class="dark:bg-zinc-700" />
                        </div>
                    ...
                    <form on:submit|preventDefault={searchContestYearMonth} class="flex gap-2 items-center justify-center">
                        <div>
                            <Label for="yearMonth"><span class="text-sm">Skyblock Year</span></Label>
                            <Input id="yearMonth" placeholder="Day" size="md" bind:value={yearVal} class="dark:bg-zinc-700" />
                        </div>
                        /
                        <div>
                            <Label for="monthYear"><span class="text-sm">Skyblock Month</span></Label>
                            <Input id="monthYear" placeholder="Day" size="md" bind:value={monthVal} class="dark:bg-zinc-700" />
                        </div>
                    ...
                    <form on:submit|preventDefault={searchContest} class="flex gap-2 items-center justify-center">
                        <div>
                            ...
                            <Input id="year" placeholder="Day" size="md" bind:value={yearVal} class="dark:bg-zinc-700" />
                        </div>
                        /
                        <div>
                            <Label for="month"><span class="text-sm">SB Month</span></Label>
                            <Input id="month" placeholder="Day" size="md" bind:value={monthVal} class="dark:bg-zinc-700" />
                        </div>
                        /
                        <div>
