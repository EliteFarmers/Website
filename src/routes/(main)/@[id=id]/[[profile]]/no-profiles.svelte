...
<section class="mx-auto my-12 flex w-full max-w-5xl flex-col gap-6 md:px-4">
	<div
		class="flex flex-col gap-6 rounded-3xl border bg-card p-6 shadow-xl md:flex-row md:items-center md:justify-between"
	>
	...
	<div class="grid gap-4 md:grid-cols-2">
		<div class="rounded-2xl border bg-card p-5">
			<p class="mb-1 text-sm font-medium text-muted-foreground">UUID</p>
		...
		{#if guildName}
			<div class="rounded-2xl border bg-card p-5">
				<p class="mb-1 text-sm font-medium text-muted-foreground">Guild</p>
		...
		{#if account.discordUsername || account.discordId}
			<div class="rounded-2xl border bg-card p-5">
				<p class="mb-1 text-sm font-medium text-muted-foreground">Linked Discord</p>
		...
		{#if firstLogin}
			<div class="rounded-2xl border bg-card p-5">
				<p class="mb-1 text-sm font-medium text-muted-foreground">First Seen on Hypixel</p>
		...
		{#if lastLogin}
			<div class="rounded-2xl border bg-card p-5">
				<p class="mb-1 text-sm font-medium text-muted-foreground">Last Login</p>
	...
	>
		...
		{#if knownProfileCount > 0}
			<p class="mt-2 font-medium text-destructive/80">
