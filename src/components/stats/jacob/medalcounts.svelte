...
<div class="flex flex-wrap justify-center gap-2 md:flex-row md:gap-4">
	{#if participations}
		<div class="flex flex-1 items-center justify-center gap-2 rounded-md bg-card text-card-foreground">
			<Popover.Mobile>
				{#snippet trigger()}
	...
	{#each Object.entries(medals) as [medal, amount] (medal)}
		<div
			class="flex max-w-24 min-w-16 flex-1 basis-8 items-center justify-center gap-2 rounded-md bg-card p-1 text-card-foreground md:p-2"
		>
