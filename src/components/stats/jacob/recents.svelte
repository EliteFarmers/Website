	...
	<div class="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
		...
		{#if recentContests.length > 0}
			<a
				...
				class="flex flex-row items-center justify-center gap-0.5 rounded-md border-l-4 bg-card p-2 text-card-foreground hover:bg-muted hover:shadow-lg dark:border-zinc-700"
			>
