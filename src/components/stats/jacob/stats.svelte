...
<div class="flex flex-col mb-2 gap-2">
	...
	<div class="flex flex-col justify-center w-full md:flex-row gap-2 md:gap-4">
		<div
			class="flex flex-row md:flex-col justify-center items-center gap-3 md:gap-1 p-1 md:p-2 rounded-md text-center w-full bg-gray-100 dark:bg-zinc-800"
		>
			<div class="flex flex-row gap-2 items-baseline justify-center">
				{#if firstPlacesRank !== -1}
					<a
						...
						class="pd-0.5 px-1.5 bg-gray-200 dark:bg-zinc-900 rounded-md hover:bg-gray-300 hover:dark:bg-zinc-700"
					>
		...
		<div
			class="flex flex-row md:flex-col align-bottom justify-center items-center gap-3 md:gap-1 p-1 md:p-2 rounded-md text-center w-full bg-gray-100 dark:bg-zinc-800"
		>
			<div class="flex flex-row gap-2 items-baseline justify-center">
