...
<section>
	<nav class="flex justify-between justify-items-center bg-gray-100 p-2">
		<section class="flex gap-2 mr-3 justify-start w-1/5 md:w-1/4">
			<a class="block sm:hidden p-3 hover:bg-gray-50" href="/">Elite</a>
			<a class="hidden sm:block p-3 hover:bg-gray-50" href="/">EliteDev</a>
		...
		<section class="flex gap-2 ml-3 justify-end w-1/5 md:w-1/4">
			...
			<div hidden={discordUser !== false}>
				<a
					data-sveltekit-reload
					class="bg-gray-200 hidden md:block p-3 rounded-md hover:bg-gray-50"
					href="/login">Discord Login</a
				>
				<a
					data-sveltekit-reload
					class="bg-gray-200 block md:hidden p-3 rounded-md hover:bg-gray-50"
					href="/login">Login</a
				>
			</div>
			<!-- Logout button -->
