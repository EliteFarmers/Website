...
<div class="flex flex-col gap-2">
	...
	<div class="flex flex-row items-center justify-start gap-2">
		...
		<span class="text-xs text-muted-foreground">
			By posting, you agree to our <a href="/terms" class="underline hover:text-primary/75">Terms of Service</a>
			and <a href="/privacy" class="underline hover:text-primary/75">Privacy Policy</a>.
		</span>
	</div>
</div>
