 ...
 */
import type { GreenhouseReplacementTriggerDto } from './GreenhouseReplacementTriggerDto';

export type ListOfGreenhouseReplacementTriggerDto = GreenhouseReplacementTriggerDto[];
