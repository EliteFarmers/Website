 ...
 */
import type { GreenhouseMovingSupportPlacementDto } from './GreenhouseMovingSupportPlacementDto';

export type ListOfGreenhouseMovingSupportPlacementDto = GreenhouseMovingSupportPlacementDto[];
