 ...
 */
import type { GreenhouseEffectPathNodeDto } from './GreenhouseEffectPathNodeDto';

export type IReadOnlyListOfGreenhouseEffectPathNodeDto = GreenhouseEffectPathNodeDto[];
