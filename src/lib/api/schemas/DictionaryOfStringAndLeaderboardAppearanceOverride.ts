 ...
 */
import type { LeaderboardAppearanceOverride } from './LeaderboardAppearanceOverride';

export interface DictionaryOfStringAndLeaderboardAppearanceOverride {
	[key: string]: LeaderboardAppearanceOverride;
}
