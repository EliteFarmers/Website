...
export type GreenhouseProfitCalculationStatus =
	(typeof GreenhouseProfitCalculationStatus)[keyof typeof GreenhouseProfitCalculationStatus];

export const GreenhouseProfitCalculationStatus = {
	ready: 'ready',
