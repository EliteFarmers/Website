 ...
 */
import type { GreenhouseMovingSupportCleanupDto } from './GreenhouseMovingSupportCleanupDto';

export type ListOfGreenhouseMovingSupportCleanupDto = GreenhouseMovingSupportCleanupDto[];
