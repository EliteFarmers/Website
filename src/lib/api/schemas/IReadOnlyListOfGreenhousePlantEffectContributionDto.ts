 ...
 */
import type { GreenhousePlantEffectContributionDto } from './GreenhousePlantEffectContributionDto';

export type IReadOnlyListOfGreenhousePlantEffectContributionDto = GreenhousePlantEffectContributionDto[];
