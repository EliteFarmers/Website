 ...
 */
import type { ListOfDungeonBestRunResponse } from './ListOfDungeonBestRunResponse';

export interface DictionaryOfStringAndListOfDungeonBestRunResponse {
	[key: string]: ListOfDungeonBestRunResponse;
}
