 ...
 */
import type { GreenhouseMovingSupportSetupOnlyCostDto } from './GreenhouseMovingSupportSetupOnlyCostDto';

export type ListOfGreenhouseMovingSupportSetupOnlyCostDto = GreenhouseMovingSupportSetupOnlyCostDto[];
