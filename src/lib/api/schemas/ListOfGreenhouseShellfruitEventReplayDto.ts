 ...
 */
import type { GreenhouseShellfruitEventReplayDto } from './GreenhouseShellfruitEventReplayDto';

export type ListOfGreenhouseShellfruitEventReplayDto = GreenhouseShellfruitEventReplayDto[];
