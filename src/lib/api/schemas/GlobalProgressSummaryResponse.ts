 ...
 */
import type { GlobalProgressSummaryPeriod } from './GlobalProgressSummaryPeriod';

export interface GlobalProgressSummaryResponse {
	current: GlobalProgressSummaryPeriod;
	previous?: GlobalProgressSummaryPeriod | null;
}
