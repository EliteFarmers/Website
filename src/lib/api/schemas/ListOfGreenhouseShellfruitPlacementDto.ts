 ...
 */
import type { GreenhouseShellfruitPlacementDto } from './GreenhouseShellfruitPlacementDto';

export type ListOfGreenhouseShellfruitPlacementDto = GreenhouseShellfruitPlacementDto[];
