 ...
 */
import type { GreenhouseShellfruitActionDto } from './GreenhouseShellfruitActionDto';

export type ListOfGreenhouseShellfruitActionDto = GreenhouseShellfruitActionDto[];
