 ...
 */
import type { GreenhouseSupportingPlantDto } from './GreenhouseSupportingPlantDto';

export type IReadOnlyListOfGreenhouseSupportingPlantDto = GreenhouseSupportingPlantDto[];
