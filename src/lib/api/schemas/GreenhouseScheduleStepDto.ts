 ...
 */
import type { IReadOnlyListOfGreenhouseScheduledActionDto } from './IReadOnlyListOfGreenhouseScheduledActionDto';

export interface GreenhouseScheduleStepDto {
	atHour: number;
	label: string;
	actions: IReadOnlyListOfGreenhouseScheduledActionDto;
	/** @nullable */
