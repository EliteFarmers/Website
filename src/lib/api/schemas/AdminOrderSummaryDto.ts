 ...
 */
import type { AdminOrderSummaryDtoPayment } from './AdminOrderSummaryDtoPayment';
import type { AdminOrderSummaryDtoRecurring } from './AdminOrderSummaryDtoRecurring';
...
export interface AdminOrderSummaryDto {
	...
	itemCount: number;
	/** @nullable */
	payment?: AdminOrderSummaryDtoPayment;
	/** @nullable */
	recurring?: AdminOrderSummaryDtoRecurring;
}
