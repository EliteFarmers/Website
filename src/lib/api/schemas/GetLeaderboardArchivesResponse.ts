 ...
 */
import type { LeaderboardArchiveSummaryDto } from './LeaderboardArchiveSummaryDto';

export interface GetLeaderboardArchivesResponse {
	leaderboard: string;
	archives: LeaderboardArchiveSummaryDto[];
}
