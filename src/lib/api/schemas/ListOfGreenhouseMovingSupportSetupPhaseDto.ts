 ...
 */
import type { GreenhouseMovingSupportSetupPhaseDto } from './GreenhouseMovingSupportSetupPhaseDto';

export type ListOfGreenhouseMovingSupportSetupPhaseDto = GreenhouseMovingSupportSetupPhaseDto[];
