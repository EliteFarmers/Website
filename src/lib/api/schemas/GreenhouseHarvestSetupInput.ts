...
export interface GreenhouseHarvestSetupInput {
	id: string;
	label: string;
	effectiveFarmingFortune: number;
	additionalCropFortune: DictionaryOfStringAndDouble;
	overbloom: number;
	rareCropArmorPieces: DictionaryOfStringAndInt32;
	/** @nullable */
	toolId?: string | null;
	/** @nullable */
	petId?: string | null;
