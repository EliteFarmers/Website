 ...
 */
import type { ListOfGreenhousePriceChannel } from './ListOfGreenhousePriceChannel';

export interface GreenhouseMarketInput {
	buyChannels: ListOfGreenhousePriceChannel;
	sellChannels: ListOfGreenhousePriceChannel;
	feePercent: number;
