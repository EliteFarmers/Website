 ...
 */
import type { GreenhouseShellfruitSurfaceChangeDto } from './GreenhouseShellfruitSurfaceChangeDto';

export type ListOfGreenhouseShellfruitSurfaceChangeDto = GreenhouseShellfruitSurfaceChangeDto[];
