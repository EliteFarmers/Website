 ...
 */
import type { GreenhouseGardenChipInput } from './GreenhouseGardenChipInput';

export interface DictionaryOfStringAndGreenhouseGardenChipInput {
	[key: string]: GreenhouseGardenChipInput;
}
