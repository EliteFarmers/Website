 ...
 */
import type { LeaderboardArchiveResultStatus } from './LeaderboardArchiveResultStatus';

export interface LeaderboardArchiveResult {
	leaderboard: string;
	status: LeaderboardArchiveResultStatus;
	entryCount: number;
	/** @nullable */
