 ...
 */
import type { GreenhouseScheduledActionDto } from './GreenhouseScheduledActionDto';

export type IReadOnlyListOfGreenhouseScheduledActionDto = GreenhouseScheduledActionDto[];
