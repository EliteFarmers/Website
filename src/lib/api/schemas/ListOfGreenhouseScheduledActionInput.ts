 ...
 */
import type { GreenhouseScheduledActionInput } from './GreenhouseScheduledActionInput';

export type ListOfGreenhouseScheduledActionInput = GreenhouseScheduledActionInput[];
