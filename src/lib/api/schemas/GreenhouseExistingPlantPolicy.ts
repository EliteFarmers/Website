...
export type GreenhouseExistingPlantPolicy =
	(typeof GreenhouseExistingPlantPolicy)[keyof typeof GreenhouseExistingPlantPolicy];

export const GreenhouseExistingPlantPolicy = {
	preserve: 'preserve',
