 ...
 */
import type { GreenhouseShellfruitRemovalDto } from './GreenhouseShellfruitRemovalDto';

export type ListOfGreenhouseShellfruitRemovalDto = GreenhouseShellfruitRemovalDto[];
