...
import type { ListOfProfileMemberLoadoutDataDto } from './ListOfProfileMemberLoadoutDataDto';
import type { ListOfProfileMemberShardDataDto } from './ListOfProfileMemberShardDataDto';
...
export interface ProfileMemberDataDto {
	...
	capturedShards: ListOfProfileMemberShardDataDto;
	garden: ProfileMemberGardenDataDto;
	loadouts: ListOfProfileMemberLoadoutDataDto;
}
