 ...
 */
import type { GreenhouseActionDto } from './GreenhouseActionDto';
import type { IReadOnlyListOfString } from './IReadOnlyListOfString';

export interface GreenhouseScheduledActionDto {
	kind: string;
	guard: string;
	action: GreenhouseActionDto | null;
	waterThreshold: number;
	plantIds: IReadOnlyListOfString;
	/** @nullable */
