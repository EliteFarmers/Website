 ...
 */
import type { DictionaryOfStringAndBazaarProductSummaryDto } from './DictionaryOfStringAndBazaarProductSummaryDto';

export interface GetBazaarProductsResponse {
	products: DictionaryOfStringAndBazaarProductSummaryDto;
}
