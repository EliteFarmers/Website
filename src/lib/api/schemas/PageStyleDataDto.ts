 ...
 */
import type { PageStyleDataDtoProperties } from './PageStyleDataDtoProperties';
import type { PageStyleDataDtoBackground } from './PageStyleDataDtoBackground';

export interface PageStyleDataDto {
	properties: PageStyleDataDtoProperties;
	/** @nullable */
	background?: PageStyleDataDtoBackground;
}
