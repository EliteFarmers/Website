...
export interface DragonFightData {
	...
	mostDamage: DictionaryOfStringAndDouble;
	fastestKill: DictionaryOfStringAndDouble;
	amountSummoned: DictionaryOfStringAndDouble;
	highestRank: DictionaryOfStringAndDouble;
}
