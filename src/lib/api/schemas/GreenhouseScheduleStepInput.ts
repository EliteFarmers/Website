 ...
 */
import type { ListOfGreenhouseScheduledActionInput } from './ListOfGreenhouseScheduledActionInput';

export interface GreenhouseScheduleStepInput {
	atHour: number;
	/** @nullable */
	repeatEveryHours?: number | null;
	label: string;
	actions: ListOfGreenhouseScheduledActionInput;
}
