 ...
 */
import type { AcceptedUpcomingJacobContestsRequestContests } from './AcceptedUpcomingJacobContestsRequestContests';

export interface AcceptedUpcomingJacobContestsRequest {
	skyBlockYear: number;
	contests: AcceptedUpcomingJacobContestsRequestContests;
	acceptedAt: string;
	/** @nullable */
