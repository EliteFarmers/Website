 ...
 */
import type { GreenhouseSupportStrategyInstructionDto } from './GreenhouseSupportStrategyInstructionDto';

export type ListOfGreenhouseSupportStrategyInstructionDto = GreenhouseSupportStrategyInstructionDto[];
