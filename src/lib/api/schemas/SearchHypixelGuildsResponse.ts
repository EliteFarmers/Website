 ...
 */
import type { IReadOnlyListOfHypixelGuildSearchResultDto } from './IReadOnlyListOfHypixelGuildSearchResultDto';

export interface SearchHypixelGuildsResponse {
	results: IReadOnlyListOfHypixelGuildSearchResultDto;
}
