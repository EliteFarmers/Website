 ...
 */
import type { ListOfJacobContestDto } from './ListOfJacobContestDto';

export interface DictionaryOfInt32AndListOfJacobContestDto {
	[key: string]: ListOfJacobContestDto;
}
