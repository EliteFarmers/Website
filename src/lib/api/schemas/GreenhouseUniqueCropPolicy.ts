...
export type GreenhouseUniqueCropPolicy = (typeof GreenhouseUniqueCropPolicy)[keyof typeof GreenhouseUniqueCropPolicy];

export const GreenhouseUniqueCropPolicy = {
	none: 'none',
