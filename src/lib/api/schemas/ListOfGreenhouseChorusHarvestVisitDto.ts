 ...
 */
import type { GreenhouseChorusHarvestVisitDto } from './GreenhouseChorusHarvestVisitDto';

export type ListOfGreenhouseChorusHarvestVisitDto = GreenhouseChorusHarvestVisitDto[];
