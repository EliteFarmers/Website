...
import type { ListOfContestPlacementRecap } from './ListOfContestPlacementRecap';

export interface ContestRecap {
	total: number;
	perCrop: DictionaryOfStringAndInt32;
	highestPlacements: ListOfContestPlacementRecap;
}
