 ...
 */
import type { IReadOnlyListOfGreenhouseCellPositionDto } from './IReadOnlyListOfGreenhouseCellPositionDto';
import type { IReadOnlyListOfString } from './IReadOnlyListOfString';

export interface GreenhouseSupportStrategyInstructionDto {
	plantId: string;
	roles: IReadOnlyListOfString;
	locations: IReadOnlyListOfGreenhouseCellPositionDto;
	mustEstablish: boolean;
	treatment: string;
}
