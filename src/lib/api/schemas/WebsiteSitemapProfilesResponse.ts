 ...
 */
import type { ListOfWebsiteSitemapProfileDto } from './ListOfWebsiteSitemapProfileDto';

export interface WebsiteSitemapProfilesResponse {
	items: ListOfWebsiteSitemapProfileDto;
	/** @nullable */
