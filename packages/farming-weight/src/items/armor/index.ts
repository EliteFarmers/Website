...
export { FarmhandBoots, FarmhandChestplate, FarmhandHelmet, FarmhandLeggings } from './farmhand.js';
...
export { SproutBoots, SproutChestplate, SproutHelmet, SproutLeggings } from './sprout.js';
